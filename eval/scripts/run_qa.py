...
class DataTrainingArguments:
    ...
    dataset_name: Optional[str] = field(
        default="slovak-nlp/sklep", metadata={"help": "The name of the dataset to use (via the datasets library)."}
    )
    dataset_config_name: Optional[str] = field(
        default="question-answering", metadata={"help": "The configuration name of the dataset to use (via the datasets library)."}
    )
